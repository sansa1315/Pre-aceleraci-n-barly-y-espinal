...
//        }
        ...
        holder.itemView.setOnClickListener {
            var intent = Intent(holder.itemView.context, ActorActivity::class.java)
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
            intent.putExtra("actor_id", castList[position].id.toString())
            holder.itemView.context.startActivity(intent)
//            Toast.makeText(holder.itemView.context, "hola mundo", Toast.LENGTH_SHORT).show()
